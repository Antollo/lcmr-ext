...
class Pytorch3DFourierBuilder(Pytorch3DShapeBuilder):
    ...
    def _build(self, objects: Object) -> Meshes:
        ...
        colors = colors.repeat(1, 1, 1, self.n_verts, 1).flatten(2, 3).flatten(0, 1)  # flatten objects in layers, flatten layers and batch
        ...
        verts[:, :, :, 2, None] = objects.appearance.confidence.flatten(0, 1)[..., None, :]
